...
public class ClasseFunz{
    public static void main(String[] args){
        
        String path1="EmotionalSongs\\ListaDiProva.csv";
        String path2="EmotionalSongs\\CreaPlaylistProva.csv";
        String line="";
        Scanner scan=new Scanner(System.in);

        String[] brani=new String[100];
        String[] autori=new String[100];
        String[] anno=new String[100];
        ...
        try{
            ...
            System.out.println("Digita \"a\" se vuoi comporre la playlist inserendo brani a tua scelta.");
            System.out.println("Digita \"b\" se vuoi comporre la playlist inserendo tutti i brani di un autore a tua scelta.");
            System.out.println("Digita \"c\" se vuoi comporre la playlist inserendo tutti i brani di anno a tua scelta.");
            ...
            if(scelta=='a'){
                System.out.println("Hai scelto di mettere brani singoli");
            }
            if(scelta=='b'){
                System.out.println("Hai scelto di mettere brani per autore");
            }
            if(scelta=='c'){
                System.out.println("Hai scelto di mettere brani per anno");
            }
