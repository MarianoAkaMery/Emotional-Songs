...
public class RegistrazioneUtente extends LoginChecker{
     ...
     */
    public static boolean Registrazione() throws FileNotFoundException{
            ...
            */ 
            ...
            if (LoginSession.size()==7){
                ...
                try {
                    ...
                    File file=new File("emotionalsongs.data.UtentiRegistrati.dati.csv" );
